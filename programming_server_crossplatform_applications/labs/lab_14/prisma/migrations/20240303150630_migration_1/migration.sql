...
CREATE TABLE [dbo].[AUDITORIUM] (
    ...
    CONSTRAINT [PK__AUDITORI__5372601057953647] PRIMARY KEY CLUSTERED ([AUDITORIUM])
);
...
-- AddForeignKey
ALTER TABLE [dbo].[AUDITORIUM] ADD CONSTRAINT [FK__AUDITORIU__AUDIT__30F848ED] FOREIGN KEY ([AUDITORIUM_TYPE]) REFERENCES [dbo].[AUDITORIUM_TYPE]([AUDITORIUM_TYPE]) ON DELETE NO ACTION ON UPDATE NO ACTION;
