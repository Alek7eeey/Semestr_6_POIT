...
SELECT geom.STAsText() AS WKT_Description FROM ne_50m_admin_0_map_units

-- 10
select * from ne_50m_admin_0_map_units;

-- 10.1.

SELECT obj1.geom.STIntersection(obj2.geom) AS Intersection
FROM ne_50m_admin_0_map_units obj1, ne_50m_admin_0_map_units obj2
WHERE obj1.qgs_fid = 1 AND obj2.qgs_fid = 1

-- 10.2.

SELECT geom.STPointN(1).ToString() AS VertexCoordinates
FROM ne_50m_admin_0_map_units
WHERE qgs_fid = 1
...
-- 13.
create index Geometry_index on ne_50m_admin_0_map_units(qgs_fid);
