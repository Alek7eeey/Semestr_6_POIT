...
VALUES (1, 1, 2, TO_DATE('2023-06-01', 'YYYY-MM-DD'),TO_DATE('2023-07-01', 'YYYY-MM-DD'));

INSERT INTO Передвижения_по_должностям (ID, Сотрудник_ID, Должность_ID, Дата_начала, Дата_окончания)
VALUES (2, 1, 3, TO_DATE('2023-07-02', 'YYYY-MM-DD'), NULL);

INSERT INTO Передвижения_по_должностям (ID, Сотрудник_ID, Должность_ID, Дата_начала, Дата_окончания)
VALUES (3, 2, 1, TO_DATE('2023-04-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Передвижения_по_должностям (ID, Сотрудник_ID, Должность_ID, Дата_начала, Дата_окончания)
VALUES (4, 3, 4, TO_DATE('2023-01-01', 'YYYY-MM-DD'), TO_DATE('2023-12-01', 'YYYY-MM-DD'));

INSERT INTO Передвижения_по_должностям (ID, Сотрудник_ID, Должность_ID, Дата_начала, Дата_окончания)
VALUES (5, 3, 5, TO_DATE('2023-12-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Передвижения_по_должностям (ID, Сотрудник_ID, Должность_ID, Дата_начала, Дата_окончания)
VALUES (6, 4, 2, TO_DATE('2023-11-01', 'YYYY-MM-DD'), NULL);
...
VALUES (1, 1, 1, TO_DATE('2023-01-01', 'YYYY-MM-DD'), TO_DATE('2023-02-01', 'YYYY-MM-DD'));

INSERT INTO Передвижение_по_отделам (ID, Сотрудник_ID, Отдел_ID, Дата_начала, Дата_окончания)
VALUES (2, 1, 1, TO_DATE('2023-02-02', 'YYYY-MM-DD'), NULL);

INSERT INTO Передвижение_по_отделам (ID, Сотрудник_ID, Отдел_ID, Дата_начала, Дата_окончания)
VALUES (3, 2, 1, TO_DATE('2023-03-01', 'YYYY-MM-DD'), TO_DATE('2023-11-01', 'YYYY-MM-DD'));

INSERT INTO Передвижение_по_отделам (ID, Сотрудник_ID, Отдел_ID, Дата_начала, Дата_окончания)
VALUES (4, 2, 1, TO_DATE('2023-11-02', 'YYYY-MM-DD'), NULL);

INSERT INTO Передвижение_по_отделам (ID, Сотрудник_ID, Отдел_ID, Дата_начала, Дата_окончания)
VALUES (5, 3, 1, TO_DATE('2023-05-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Передвижение_по_отделам (ID, Сотрудник_ID, Отдел_ID, Дата_начала, Дата_окончания)
VALUES (6, 4, 1, TO_DATE('2023-06-01', 'YYYY-MM-DD'), TO_DATE('2023-10-01', 'YYYY-MM-DD'));

INSERT INTO Передвижение_по_отделам (ID, Сотрудник_ID, Отдел_ID, Дата_начала, Дата_окончания)
VALUES (7, 4, 2, TO_DATE('2023-10-02', 'YYYY-MM-DD'), NULL);
...
(
    ...
    WHERE
        Z.Дата BETWEEN TO_DATE('2023-01-01', 'YYYY-MM-DD') AND TO_DATE('2023-06-01', 'YYYY-MM-DD')
    GROUP BY
